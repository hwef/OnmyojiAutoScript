...
class NianTrueAsset:
	...
	# 华北年兽
	I_N_HUABEI = RuleImage(roi_front=(409,330,156,45), roi_back=(409,330,156,45), threshold=0.7, method="Template matching", file="./tasks/NianTrue/nian/nian_n_huabei.png")
	# 年兽战斗结束，通关奖励
	I_BATTLE_OVER = RuleImage(roi_front=(531,212,205,61), roi_back=(531,212,205,61), threshold=0.7, method="Template matching", file="./tasks/NianTrue/nian/nian_battle_over.png")
	# 年兽来袭页面
	I_N_PAGE = RuleImage(roi_front=(94,29,129,40), roi_back=(94,29,129,40), threshold=0.7, method="Template matching", file="./tasks/NianTrue/nian/nian_n_page.png")
	# 年兽战斗结束，已经拥有转为金币，点击确认
	I_N_OK = RuleImage(roi_front=(593,442,100,65), roi_back=(593,442,100,65), threshold=0.7, method="Template matching", file="./tasks/NianTrue/nian/nian_n_ok.png")

...
class RichManAssets:
	...
	# Image Rule Assets
	# 海月火玉
	I_HAIYUE = RuleImage(roi_front=(962,240,95,95), roi_back=(151,165,984,220), threshold=0.8, method="Template matching", file="./tasks/RichMan/sea/Screenshots_haiyue.png")
	# 狂骨
...
# 皮肤券判断是否到末端
	...
	# 随机御魂 
	I_ME_SOULS = RuleImage(roi_front=(173,349,148,175), roi_back=(121,116,898,476), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_souls.png")
	# 白蛋 
	...
	# 挑战券
	I_ME_CHALLENGE_PASS = RuleImage(roi_front=(638,176,100,100), roi_back=(121,92,898,500), threshold=0.8, method="Template matching", file="./tasks/RichMan/mall/medal/medal_me_challenge_pass.png")
	# 红蛋 

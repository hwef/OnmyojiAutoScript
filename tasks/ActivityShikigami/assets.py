...
class ActivityShikigamiAssets: 
	...
	# Image Rule Assets
	# 进入活动 
	I_SHI = RuleImage(roi_front=(555,213,33,34), roi_back=(506,185,232,94), threshold=0.7, method="Template matching", file="./tasks/ActivityShikigami/as/as_shi.png")
	# 左上角返回 
	...
	# 活动票数（没有百分比） 
	O_REMAIN_AP_ACTIVITY2 = RuleOcr(roi=(555,18,50,29), area=(555,18,50,29), mode="Digit", method="Default", keyword="", name="remain_ap_activity2")
	# Ocr-description 

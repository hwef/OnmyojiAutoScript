...
class WeeklyTriflesAssets: 
	...
	# Image Rule Assets
	# 点击“式神” 
	I_WT_SHIKIAGMI = RuleImage(roi_front=(494,650,56,49), roi_back=(289, 618, 819, 100), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/collect/collect_wt_shikiagmi.png")
	# 点击式神绘卷 
	...
	# 秘闻分享 
	I_WT_SE_SHARE = RuleImage(roi_front=(897,559,85,64), roi_back=(897,559,85,64), threshold=0.8, method="Template matching", file="./tasks/WeeklyTrifles/secret/secret_wt_se_share.png")
	# 微信 

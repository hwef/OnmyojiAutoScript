...
class AutoCakeAssets:
	...
	# 红色退出
	I_RED_EXIT = RuleImage(roi_front=(0,0,1280,720), roi_back=(0,0,1280,720), threshold=0.8, method="Template matching", file="./tasks/ActivityShikigami/as/as_red_exit.png")
	O_REMAIN_AP_ACTIVITY2 = RuleOcr(roi=(1172,17,43,29), area=(1172,17,43,29), mode="Digit", method="Default", keyword="", name="remain_ap_activity2")

...
class GameUiAssets: 
	...
	# description 
	I_CHECK_DAILY = RuleImage(roi_front=(27,515,69,62), roi_back=(1,489,155,127), threshold=0.7, method="Template matching", file="./tasks/GameUi/page/page_check_daily.png")
	# description 

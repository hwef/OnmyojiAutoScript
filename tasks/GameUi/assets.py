...
class GameUiAssets: 
	...
	# description 
	I_CHECK_DAILY = RuleImage(roi_front=(27,515,69,62), roi_back=(1,489,155,127), threshold=0.6, method="Template matching", file="./tasks/GameUi/page/page_check_daily.png")
	# description 
	...
	# description 
	I_CHECK_COLLECTION = RuleImage(roi_front=(471,618,100,100), roi_back=(289, 618, 819, 100), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_collection.png")
	# description 

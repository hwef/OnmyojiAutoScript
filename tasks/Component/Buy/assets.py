...
class BuyAssets: 
	...
	# 购买溢出取消 
	I_BUY_CANCEL = RuleImage(roi_front=(502,405,68,34), roi_back=(455,359,184,120), threshold=0.8, method="Template matching", file="./tasks/Component/Buy/buy/buy_cancel.png")
